...
public class SmartDisplayLinkScreen extends AbstractSimiScreen {
    ...
    protected void init() {
        ...
        nameInput.setTooltip(Tooltip.create(
                Component.translatable("create_beamline.screen.smart_display_link.name_tooltip.title").withStyle(s -> s.withColor(AbstractSimiWidget.HEADER_RGB.getRGB()))
    ...
    public void onConfirm(boolean backToSelection) {
        ...
        Packets.sendToServer(new SmartDisplayLinkConfigurationPacket(
